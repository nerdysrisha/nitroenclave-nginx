...
##############START -ONE TIME ACTIVITY ############# TIME ACTIVITY  ONE TIME ACTIVITY  ONE TIME ACTIVITY 
#On ubuntu host
...
##############END -ONE TIME ACTIVITY ############# TIME ACTIVITY  ONE TIME ACTIVITY  ONE TIME ACTIVITY 
...
#This step will be required to be executed every one hour as the token expires after one hour. 
...
docker tag hello-e97d44ea-c1e5-4673-898d-0708577184c6:latest nerdysrisha/hello-aws-nitro:latest
...
kubectl exec -it hello-enclave-deployment-7957fd4d58-fq9fv -n integrations -- /bin/bash
...
#CONTINUE FROM HERE ON 21 OCT OR SUNDAY
